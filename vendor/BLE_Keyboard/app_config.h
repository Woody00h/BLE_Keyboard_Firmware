...
#define		KB_MAP_NORMAL	{\
				...
				{VK_L_CTRL,		VK_L_WIN,		VK_L_ALT,	VK_SPACE,		VK_R_ALT,		VK_FN,		VK_APP,			VK_LEFT, 	VK_R_CTRL,	VK_DOWN},\
				{VK_F10,		VK_F11,			VK_F12,		VK_PRINTSCREEN,	VK_SCR_LOCK,	VK_PAUSE,	VK_SLASH,		VK_ENTER,	VK_R_SHIFT,	VK_RIGHT},\
				{VK_P,			VK_LBRACE,		VK_RBRACE,	VK_BACKSLASH,	VK_DELETE,		VK_END,		VK_PAGE_DOWN,	VK_UP,		VK_QUOTE,	VK_SEMICOLON},\
